...
class DestinationsControllerTest < ActionController::TestCase
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post :create, destination: { name: @destination.name, price: @destination.price, state_id: @destination.state_id, status: @destination.status }
    end
  ...
  test "should update destination" do
    put :update, id: @destination, destination: { name: @destination.name, price: @destination.price, state_id: @destination.state_id, status: @destination.status }
    assert_redirected_to destination_path(assigns(:destination))
  end
